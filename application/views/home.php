    ...
    <div class="navbar-fixed-top">
      <div class="">
       ...
       <div class="container header-fixed-color margin-bottom-10 ">
        <div class="notes-top"> <div class="pull-left"><i class="fa fa-home"></i> <span class="notes-txt">Dashboard</span></div>
      <div class="srvr-tme  pull-right"><b class="sys-time"><span class="profile-time" id="profile-time"><?php //echo date('h:i:s a');?></span></b></div>
      </div>
    </div>
    </div>
    <div class="container">
...
<script>
        ...
        {
          var date  = '<?php echo date('M D d Y').' '.date('h:i:s a');?>';
          ...
          timer = timer + 1000;
          document.getElementById("profile-time").innerHTML= currentMonth+' ' + currentDate+'  ' + currentYear + ' ' + strTime ;
          flag_time = false;
        }
